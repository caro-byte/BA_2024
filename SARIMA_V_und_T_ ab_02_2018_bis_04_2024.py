...
plt.plot(val_data.index, val_data['y'], label='Validierungsdaten', color='blue', linestyle='-')
plt.plot(val_data.index, val_forecast, label='Validierungsvorhersage', color='blue', linestyle='--')

# Plot test data and forecast
plt.plot(test_data.index, test_data['y'], label='Testdaten', color='green', linestyle='-')
plt.plot(test_data.index, test_forecast, label='Testvorhersage', color='green', linestyle='--')

plt.title('Validierungs- und Testvorhersagen')
