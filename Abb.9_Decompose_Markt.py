...
def plot_decomposition(result, color='black', scale=1):
...
result = seasonal_decompose(df['Summe Monat'], model='additive', period=12)

# Plot the decomposition with customization
plot_decomposition(result, color='black', scale=1.2)  # You can adjust the scale factor as needed
