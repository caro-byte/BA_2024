...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul 22 10:50:13 2024
...
ax.set_xlabel('Jahr', fontweight='bold', fontsize=20, fontname='Arial')
...
ax.axvline(pd.Timestamp('2022-06-01'), color='grey', linestyle=':', linewidth=1.7)
ax.axvline(pd.Timestamp('2023-04-01'), color='grey', linestyle=':', linewidth=1.7)
